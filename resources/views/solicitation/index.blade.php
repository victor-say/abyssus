            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-slate-700 text-white">
                        <tr>
                            <th class="px-6 py-3 text-left text-sm font-semibold">Id do Usuário</th>
                            <th class="px-6 py-3 text-left text-sm font-semibold">tipo</th>
                            <th class="px-6 py-3 text-left text-sm font-semibold">Pedido</th>
                    ...
                    <tbody class="divide-y divide-gray-400">
                        @forelse ($solicitations as $solicitation)
                            <tr class="hover:bg-gray-200 transition-colors">
                                <td class="px-6 py-3">{{ $solicitation->id_user }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-8 text-center text-gray-600">
                                    Nenhuma Solicitação encontrada no banco
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
