...
<div class="min-h-screen flex justify-center items-center  bg-gray-700">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-3xl" >
        ...
        <div class="flex gap-4 mt-8">
            ...
            <button type="button"onclick="confirmDelete({{ $solicitation->id }})"  class="inline-flex items-center gap-1 px-3 py-1 bg-red-600 text-white text-sm rounded hover:bg-red-800 transition-colors hover:-translate-y-1"">
                Excluir
