...
<div class="flex min-h-screen bg-gray-400">
    ...
    <main class="flex-1 p-6">
        ...
        <header class="w-full bg-zinc-300 shadow-lg shadow-indigo-500/50 rounded-lg p-4 mb-6">
            ...
            <div class="mt-4">
                <a href="{{ route('books.create')}}" class="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500 text-white font-medium rounded hover:bg-cyan-600 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <table class="w-full">
                    <thead class="bg-slate-700 text-white">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-sm font-semibold">Paginas</th>                            
                            <th class="px-6 py-3 text-left text-sm font-semibold">Editora</th>
                            <th class="px-6 py-3 text-left text-sm font-semibold">Gênero</th>
                            <th class="px-6 py-3 text-left text-sm font-semibold">Publico Alvo</th>
                    ...
                    <tbody class="divide-y divide-gray-400">
                        @forelse ($books as $book)
                            <tr class="hover:bg-gray-200 transition-colors">
                                <td class="px-6 py-3 text-left">{{ $book->name }}</td>
                                <td class="px-6 py-3 text-left">{{ $book->author }}</td>
                                <td class="px-6 py-3 text-left">{{ $book->pages }}</td>
                                <td class="px-6 py-3 text-left">{{ $book->publisher }}</td>
                                <td class="px-6 py-3 text-left">{{ $book->genero }}</td>
