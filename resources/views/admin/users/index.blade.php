...
<div class="flex min-h-screen bg-gray-400">
    ...
    <main class="flex-1 p-6">
        ...
        <header class="w-full bg-zinc-300 shadow-lg shadow-indigo-500/50 rounded-lg p-4 mb-6">
            ...
            <div class="mt-4">
                <a href="{{ route('users.create')}}" class="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500 text-white font-medium rounded hover:bg-cyan-600 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <tbody class="divide-y divide-gray-400">
                        @forelse ($users as $user)
                            <tr class="hover:bg-gray-200 transition-colors">
                                ...
                                <td class="px-6 py-3">{{ $user->class }}</td>
                                ...
                                <td class="px-6 py-3 text-center">
                                    <a href="{{ route('users.show', $user->id) }}" class="inline-flex items-center gap-1 px-3 py-1 bg-blue-800 text-white text-sm rounded hover:bg-blue-600 transition-colors hover:-translate-y-1">
                                        Detalhes
